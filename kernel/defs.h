...
void            ukvfree(pagetable_t pagetable);
void            uvminithart(pagetable_t pagetable);
void            ukvminit(pagetable_t pagetable);
void            ukvmmap(pagetable_t pagetable, uint64 va, uint64 pa, uint64 sz, int perm);
int             kuvmcopy(pagetable_t old, pagetable_t new, uint64 oldsz, uint64 newsz);
uint64          kvmdealloc(pagetable_t pagetable, uint64 oldsz, uint64 newsz, int opt);
